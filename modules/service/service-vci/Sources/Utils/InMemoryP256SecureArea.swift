...
public extension MdocDataModel18013.CoseKeyPrivate {
    // decode cbor string
    init?(p256 x963: String, privateKeyId: String) {
...
public func generateOpenId4VpHandover(clientId: String,  responseUri: String, nonce: String, jwkThumbprint: [UInt8]? = nil) -> CBOR {
