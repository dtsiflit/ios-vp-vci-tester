...
public struct CredentialPresentationResultView<Router: RouterGraphType>: View {

  @Environment(\.colorScheme) var colorScheme
  @Environment(\.localizationController) var localization

  @ObservedObject private var viewModel: CredentialPresentationResultViewModel<Router>

  public init(with viewModel: CredentialPresentationResultViewModel<Router>) {
